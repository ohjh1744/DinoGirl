...
public class GachaCheck : MonoBehaviour
{
    ...
    public void SendChangeValue(string itemName, int amount, DatabaseReference root, PlayerData playerData)
    {
        int result = 0;
        ...
        switch (itemName)
        {
            case "Coin":
                ...
                // items = root.Child(BackendManager.Auth.CurrentUser.UserId).Child("_items/0");
                // Test용
            ...
            case "DinoBlood":
                ...
                // 실제 빌드 시 사용 - UserId불러오기
                // items = root.Child(BackendManager.Auth.CurrentUser.UserId).Child("_items/1");
                // Test용
            ...
            case "BoneCrystal":
                ...
                // 실제 빌드 시 사용 - UserId불러오기
                // items = root.Child(BackendManager.Auth.CurrentUser.UserId).Child("_items/2");
                // Test용
            ...
            case "DinoStone":
                ...
                // 실제 빌드 시 사용 - UserId불러오기
                // items = root.Child(BackendManager.Auth.CurrentUser.UserId).Child("_items/3");
                // Test용
            ...
            case "Stone":
                ...
                // 실제 빌드 시 사용 - UserId불러오기
                // items = root.Child(BackendManager.Auth.CurrentUser.UserId).Child("_items/4");
                // Test용
